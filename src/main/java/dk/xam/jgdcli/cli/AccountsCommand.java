...
public class AccountsCommand {
    ...
    static class ListCommand implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            List<DriveAccount> accounts = service.listAccounts();
            if (accounts.isEmpty()) {
                System.out.println("No accounts configured");
            } else {
                for (DriveAccount account : accounts) {
    ...
    static class CredentialsCommand implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            if (list) {
                ...
                System.out.println("  jgdcli accounts credentials <file.json> [--name <name>]");
                System.out.println("  jgdcli accounts credentials --list");
                System.out.println("  jgdcli accounts credentials --remove <name>");
                return 1;
            }
        }
